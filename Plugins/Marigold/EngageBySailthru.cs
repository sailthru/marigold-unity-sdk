...
namespace MarigoldSDK {
	...
	#nullable disable
		...
		public static void LogAbandonedCart(Purchase purchase) {
			string purchaseString = GetJsonForPurchase(purchase).ToString();
			#if UNITY_IOS
	...
	#nullable disable
		...
		public static JSONClass GetJsonForPurchase (Purchase purchase) {
		...
		public static JSONClass GetJsonForPurchaseItem (PurchaseItem purchaseItem) {
			JSONClass jsonObject = new JSONClass();
		...
		public static JSONClass GetJsonForPurchaseAdjustment (PurchaseAdjustment purchaseAdjustment) {
			JSONClass jsonObject = new JSONClass();
